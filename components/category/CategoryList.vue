...
<template>
  ...
  <Table>
    ...
    <TableBody>
      <TableRow v-for="category , key in categories" :key="key" class="border-gray-800">
        <TableCell>
          {{ category.name }}
        </TableCell>
        <TableCell>
        ...
        <TableCell class="text-right">
            <div class="space-x-2">
                ...
                <Button @click="handleDelete(parseInt(category.id + ''))" variant="destructive">Delete</Button>
            </div>
        </TableCell>
      </TableRow>
    </TableBody>
