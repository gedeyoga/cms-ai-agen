                        ...
                        >
                            <h2 class="text-3xl text-center mb-6">Sign In</h2>    
                                ...
                                <form id="loginForm" class="my-10" @submit="handleSubmit($event, onSubmit)">
                                    <div v-if="error" class="bg-red-900/90 w-full rounded p-3 mb-5 text-xs">
                                        {{ error }}
                                    </div>
                            ...
                            <div class="space-y-3">
                                <Button type="submit" form="loginForm" class="w-full mb-5">Login</Button>
                                ...
                                <div class="">
                                    <Button type="button" @click="emit('onLoginProviders' , 'whatsapp')" variant="whatsapp" class="w-full">
                                        <Icon icon="mdi:whatsapp" :ssr="true"></Icon>
                                        Whatsapp
                                    </Button>
                                </div>
                            </div>
