...
<template>
        <Dialog modal :open="isOpen">
            ...
            <DialogContent class="sm:max-w-[425px] [&>button]:text-white">
                ...
                <AuthWhatsappForm @close-dialog="closingDialog" @on-send-otp="(state: string) => stateForm = state" v-if="stateForm == 'send-otp'"></AuthWhatsappForm>
                <AuthWhatsappOtp @close-dialog="closingDialog" v-if="stateForm == 'validate-otp'"></AuthWhatsappOtp>
            </DialogContent>
        </Dialog>
</template>
